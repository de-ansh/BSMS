...
import {
  ...
  Search, ChevronDown, LogOut, BadgeInfo, ShieldCheck, Menu, X, Moon, Sun, Calendar, Car, MessageSquare
} from "lucide-react"
...
const navItems = [
  ...
  { icon: <MessageSquare />, label: "Community Hub", path: "/community", adminOnly: false },
